...
namespace Items
{
    ...
    public class EnemyItem : ScriptableObject
    {
        ...
        [SerializeField] private float distanceToAttackTarget;
        [SerializeField] private float distanceToPlayerTarget;
        ...
        public float DistanceToAttackTarget => distanceToAttackTarget;
        public float DistanceToPlayerTarget => distanceToPlayerTarget;
